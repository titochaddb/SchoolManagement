            ...
            <div class ="container p-md-4 p-sm-4 ">
                ...
                <div class ="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                    <div class ="col-md-3 col-md-offset-2 mb-3">
                        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#55598" Text="Add Teacher" OnClick="btnAdd_Click" />
                    </div>
                </div>
                ...
                <div class ="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                    <div class ="col-md-6">
                        <asp:GridView ID="GridView1" runat="server" CssClass="table-hover table-bordered" EmptyDataText="No record to display" 
                            ...
                            OnRowUpdating="GridView1_RowUpdating" Width="756px" OnRowDeleting="GridView1_RowDeleting">
                            <Columns>
