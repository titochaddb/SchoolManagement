            ...
            <div class ="container p-md-4 p-sm-4 ">
                ...
                <div class ="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                    <div class ="col-md-6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Gender id required" ForeColor="Red" 
                ...
                <div class ="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                    <div class ="col-md-6">
                        ...
                        <asp:TextBox ID="txtRoll" runat="server" CssClass="form-control" placeholder = "Enter Roll" required>
                        </asp:TextBox>                        
                    </div>
                    <div class ="col-md-6">
                ...
                <div class ="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
                    <div class ="col-md-3 col-md-offset-2 mb-3">
                        <asp:Button ID="btnAdd" runat="server" CssClass="btn btn-primary btn-block" BackColor="#55598" Text="Add Student" Onclick="btnAdd_Click"/>
                    </div>
                </div>
